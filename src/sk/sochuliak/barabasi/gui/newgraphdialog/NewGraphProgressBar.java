...
public class NewGraphProgressBar extends JDialog implements PropertyChangeListener {
	...
	public NewGraphProgressBar(Component owner, int growtManagement, int numberOfNodes, int numberOfEdges) {
		...
		NetworkBuildConfiguration config = NetworkBuildConfiguration.getInstance()
				.setMethodDriven(growtManagement)
				.setNodesCount(numberOfNodes)
				.setEdgesCount(numberOfEdges)
