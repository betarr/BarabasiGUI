...
import sk.sochuliak.giraphe.network.ObjectedNetwork;
...
public class ObjectedNetworkTest {
	...
	@Before
	public void setUp() {
		this.network = TestUtils.buildSimpleNetwork(new ObjectedNetwork(this.getClass().getName()));
	}
	
	private Network buildNetwork() {
		return TestUtils.buildComplexNetwork(new ObjectedNetwork(this.getClass().getName()));
	}
